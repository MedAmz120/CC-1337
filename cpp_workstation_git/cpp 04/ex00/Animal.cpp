...
/*   Updated: 2024/05/21 10:59:44 by moamzil          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    type = "Default";
    std::cout << "Animal Default Consctructor Called" << std::endl;
}

Animal::Animal(std::string& type)
{
    this->type = type;
    std::cout << type << " Animal Consctructor 2 Called" << std::endl;
}

Animal::~Animal()
{
    std::cout << "Animal Base Class Desctructor Called" << std::endl;
}
